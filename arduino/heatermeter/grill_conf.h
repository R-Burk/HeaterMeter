...
#ifndef __GRILL_CONF_H__
#define __GRILL_CONF_H__

#define GRILL_CALC_TEMP
#define GRILL_SERIAL_ENABLED
#define GRILL_SERVO_ENABLED
#define GRILL_DYNAMIC_RANGE
//#define GRILLPID_FEEDVOLT_DEBUG
//#define GRILL_USE_PID
#define GRILL_USE_FLC
...
#define CONTROLOUTPUT_AVG_SMOOTH (2.0f/240.0f)
...
#if HM_BOARD_REV == 'A'
  #undef GRILL_SERVO_ENABLED
#endif

#endif /* __GRILL_CONF_H__ */
